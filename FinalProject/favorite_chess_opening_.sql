...
--
-- Host: localhost
-- Generation Time: Dec 21, 2022 at 12:25 AM
...
INSERT INTO `favorite chess opening?` (`ChessID`, `Chess_answers`) VALUES
(1, 'Brandon Gambit');
...
--
ALTER TABLE `favorite chess opening?`
  MODIFY `ChessID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
